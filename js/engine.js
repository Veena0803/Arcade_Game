...
var Engine = (function(global) {
    ...
    function main() {
         ...
         */
        game = win.requestAnimationFrame(main);
    ...
    function showGameOverMessage(message, x, y) {
        ctx.font = "60px Arial";
        ctx.fillStyle = "red";
    ...
    function init() {
        ...
        /* Function call to initialize the clock */
        initializeClock('clockdiv', new Date(Date.parse(new Date()) + 2 * 60 * 1000));
    }

    /* Functions that calculate the timer to end the game */
    ...
    function initializeClock(id, endtime) {
        ...
        var minutesSpan = c.querySelector('.minutes');
        var secondsSpan = c.querySelector('.seconds');
        ...
        function updateClock() {
            ...
            if (t.total <= 0 || gameEnded) {
                ...
                win.cancelAnimationFrame(game);
                if (t.total <= 0) {
                    showGameOverMessage("TIME UP!", 120, 300);
                }
            }
        }
