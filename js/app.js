    ...
    canvas.addEventListener("mouseup", function(e) {
        if (!gameStarted && !gameEnded) {
            ...
            if ((x >= 5 && x <= 45) && (y >= 563 && y <= 605)) {
                ...
                player.render();
            } else if ((x >= 50 && x <= 90) && (y >= 563 && y <= 605)) {
                player.sprite = "images/char-cat-girl.png";
                player.render();
            } else if ((x >= 100 && x <= 140) && (y >= 563 && y <= 605)) {
                player.sprite = "images/char-horn-girl.png";
                player.render();
            } else if ((x >= 150 && x <= 190) && (y >= 563 && y <= 605)) {
                player.sprite = "images/char-pink-girl.png";
                player.render();
            } else if ((x >= 200 && x <= 240) && (y >= 563 && y <= 605)) {
...
var allEnemies = Enemy.createEnemies();
player = new Player();
var gems = Gems.displayGems();
